...
class PdfResourceProvider:
    def extract(self, pdf_url: str, project_name: str | None = None) -> ResourceExtractionResult:
        pages = self._extract_pdf_pages(self._read_pdf_bytes(pdf_url))
    ...
    def _read_pdf_bytes(self, pdf_url: str) -> bytes:
    ...
    def _extract_pdf_pages(self, pdf_bytes: bytes) -> list[tuple[int, str]]:
